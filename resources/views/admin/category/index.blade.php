...
<div class="modal fade" id="editar" tabindex="-1" aria-labelledby="editarLabel" aria-hidden="true">
    ...
    <form action="{{ route('admin.category.update', ':id') }}" id="formEditar" method="POST">
            @csrf
            @method('PUT')
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="edit-nombre" class="form-label">Nombre Catalogo</label>
                        <input type="text" class="form-control" id="edit-category_name" name="category_name">
                    </div>
                    <div class="mb-3">
                        <label for="edit-contacto" class="form-label">Descripcion</label>
...
<div class="modal fade" id="eliminar" tabindex="-1" aria-labelledby="eliminarLabel" aria-hidden="true">
    <div class="modal-dialog">
  <form action="{{ route('admin.category.destroy', ':id') }}" id="formEliminar" method="POST">
  @csrf
  @method('DELETE')
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Eliminar Catalogo</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
